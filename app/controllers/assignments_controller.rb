class AssignmentsController < ApplicationController
  ...
  def index
    # for phase 3 only
      @current_assignments = Assignment.current.chronological.paginate(page: params[:page]).per_page(4)
      @past_assignments = Assignment.past.chronological.paginate(page: params[:page]).per_page(4)
  end
